...
@Component
public class TokenFilter extends GenericFilterBean { //анализация авторизации по токену
    ...
    private String getTokenFromRequest(HttpServletRequest request) { //получение токена из заголовка запроса
