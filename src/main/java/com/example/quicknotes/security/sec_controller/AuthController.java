...
import com.example.quicknotes.security.security_dto.RefreshRequestDto;
...
public class AuthController {
    ...
    @PostMapping("/login")
    public ResponseEntity<Object> login(@RequestBody User user) {  // При помощи данного метода клиент отправляет на сервер
        try {
